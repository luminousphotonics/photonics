...
const acc_strength        = 1;
const pull_strength       = 0.007;
const stick_distance      = 70000;
const cursor_stick_distance = 20000;
const zIndex              = -2;     // sits behind your content
const opacity             = 0.6;
const line_color          = "254,254,254";
const count               = 90;     // fewer = lighter
...
//Particle Nest Animation
(function(){
  // copy your entire canvas-nest.js code here…
  // but replace this line:
  //   get_by_tagname("body")[0].appendChild(the_canvas);
  // with this:
  document.getElementById("spark-scroll-section").appendChild(the_canvas);

  // and change the canvas style to absolute so it sits in the section:
  the_canvas.style.cssText =
    "position:absolute;top:0;left:0;width:100%;height:100%;"
    + "z-index:-2;opacity:" + config.o + ";pointer-events:none";
