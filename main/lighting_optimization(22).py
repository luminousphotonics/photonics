...
MAX_LUMENS = 20000.0  # Maximum luminous output constraint
...
def optimize_lighting(floor_width, floor_length, height_from_floor, light_array_width, light_array_height,
    ...
    if not result.success:
        ...
        raise Exception(error_msg)  # Replace sys.exit(1) with exception
...
def run_simulation(floor_width, floor_length, target_ppfd, perimeter_reflectivity, verbose=False):
    ...
    try:
        ...
        # Propagate the exception to be handled by the Django view
        raise e
...
def main():
    ...
    try:
        ...
        # You can format and print results here if needed
    except Exception as e:
